...
check(!html.includes('dknowledger.drayker.org'), 'retired Dknowledger hostname is still linked');
check(html.includes('https://dknowledge.drayker.org/'), 'canonical Dknowledge link is missing');
